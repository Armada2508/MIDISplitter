...
class Interface(tk.Frame):
	...
	def create_gui(self):
		# Create the main gui with widgets
		self.info = tk.Frame(self.master, width=0, height=80, bg="red")
		self.input = tk.Frame(self.master, width=0, height=80, bg="orange")
		self.output = tk.Frame(self.master, width=0, height=80, bg="yellow")
		self.options = tk.Frame(self.master, width=0, height=80, bg="brown")
		self.velocity = tk.Frame(self.options, width=0, height=0, bg="blue")
		self.tracks = tk.Frame(self.options, width=0, height=0, bg="green")
		self.convert = tk.Frame(self.master, width=0, height=80, bg="purple")
		...
		self.velocity_label = tk.Label(self.velocity, font=self.font_small, text="Change All Note Velocity(Volume)")
		...
		self.tracks.pack(side=tk.RIGHT, expand=1, fill='both')
